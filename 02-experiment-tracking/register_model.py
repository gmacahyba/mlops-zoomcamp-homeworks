...
def run_register_model(data_path: str, top_n: int):
    ...
    print("Best run: ", best_run[0])
    print("Best run: ", best_run[0].info.run_id)

    # Register the best model
    mlflow.register_model(f"runs:/{best_run[0].info.run_id}/sklearn-model", "random-forest-best-model")
